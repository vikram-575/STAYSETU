    ...
    cities: [
      {
        ...
        popularLocalities: ['Koramangala', 'HSR Layout', 'Indiranagar', 'Whitefield', 'Electronic City'],
        featured: true,
      },
      {
        id: 'city-ggn',
      ...
      },
      {
        ...
        popularLocalities: ['Saket', 'Hauz Khas', 'North Campus', 'Laxmi Nagar', 'Dwarka'],
        featured: true,
      },
      {
        id: 'city-pune',
      ...
      },
      {
        ...
        listingCount: 1,
        startingPrice: 7200,
        image: 'https://images.unsplash.com/photo-1572455857811-045fb4255b5d?auto=format&fit=crop&w=600&q=80',
      ...
      },
      {
        ...
        popularLocalities: ['Powai', 'Andheri West', 'Bandra', 'Goregaon', 'Malad'],
        featured: true,
      },
      {
        id: 'city-chn',
